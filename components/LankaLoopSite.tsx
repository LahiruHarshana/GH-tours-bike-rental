...
const siteMarkup = String.raw`<div class="loader" id="loader"><div class="loader-inner"><div class="loader-logo"></div><div class="loader-word">GH tours & bike rental</div></div></div>
  <div class="cursor"></div><div class="cursor-dot"></div>
  <header class="nav-wrap"><nav class="nav"><a href="#top" class="brand" aria-label="GH tours & bike rental home"><span class="brand-mark">GH</span><span>GH tours & bike rental</span></a><div class="nav-links"><a href="#services">Services</a><a href="#book">Book now</a><a href="#safaris">Safaris</a><a href="#bikes">Bike rental</a><a href="#destinations">Destinations</a></div><div class="nav-actions"><a href="#book" class="btn btn-dark magnetic">Plan my trip <span>↗</span></a><button class="btn btn-outline menu-btn" aria-label="Open menu">☰</button></div></nav></header>
  ...
  <aside class="mobile-menu" id="mobileMenu" aria-hidden="true" aria-label="Mobile navigation">
    <div class="mobile-menu-head">
      <a href="#top" class="brand"><span class="brand-mark">GH</span><span>GH tours & bike rental</span></a>
  ...
  <footer><div class="container"><div class="footer-grid"><div class="footer-brand"><a href="#top" class="brand"><span class="brand-mark">GH</span><span>GH tours & bike rental</span></a><p>Airport taxis, private safaris, bike rentals, and tailor-made tours across Sri Lanka.</p></div><div class="footer-col"><h4>Book</h4><a href="#book">Airport taxi</a><a href="#book">Safari</a><a href="#book">Bike rental</a><a href="#book">Private tour</a></div><div class="footer-col"><h4>Discover</h4><a href="#destinations">Sigiriya</a><a href="#destinations">Ella</a><a href="#destinations">Galle</a><a href="#destinations">Mirissa</a></div><div class="footer-col"><h4>Contact</h4><a href="tel:+94770000000">+94 77 000 0000</a><a href="mailto:hello@lankaloop.lk">hello@lankaloop.lk</a><a href="#">Sri Lanka</a></div></div><div class="footer-bottom"><span>© 2026 GH tours & bike rental. Demo website—replace contact details, policies, and operating information before launch.</span><span>Photography loaded from public Unsplash image URLs. Review and retain appropriate source credits for production use.</span></div></div></footer>
  ...
  useEffect(() => {
    ...
    async function boot() {
      try {
        ...
        console.error("GH tours & bike rental animation setup failed:", error);
